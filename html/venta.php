...
?>
	<section class="banner-interna">
		<picture>
			<source media="(max-width: 767px)" srcset="assets/img/banner-venta.jpg">
			<img src="assets/img/banner-venta.jpg" alt="banner" class="interna-imagen-banner" >
		</picture>
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-lg-9">
					<div class="row fila-inmueble">
						<div class="col-12 col-lg-4 col-xl-4 columna-imagen">
							...
							<span class="label label-venta">COMPRA</span>
						</div>
