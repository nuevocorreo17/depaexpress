...
?>
	<section class="banner-interna">
		<picture>
			<source media="(max-width: 767px)" srcset="assets/img/banner-alquiler.jpg">
			<img src="assets/img/banner-alquiler.jpg" alt="banner" class="interna-imagen-banner" >
		</picture>
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-lg-9">
					<div class="row fila-inmueble">
						<div class="col-12 col-lg-4 col-xl-4 columna-imagen">
							...
							<span class="label label-alquiler">ALQUILER</span>
						</div>
								...
								<div class="col-12">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-xl-4 bloque-azul">
											<h2 class="precio-inmueble sin-desde">S/ 689,742</h2>
											<p>(US$ 204,671)</p>
										</div>
									</div>
									<div class="row">
